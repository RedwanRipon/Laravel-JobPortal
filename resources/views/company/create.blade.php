    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                @else
                    <img style="border-radius: 50px;width: 100%;margin-bottom: 5px" width="80" height="190" src="{{asset('uploads/logo')}}/{{Auth::user()->company->logo}}" alt="image">
                @endif
                ...
                <div class="card mb-2">
                    <form enctype="multipart/form-data" action="{{route('company.logo')}}" method="post">
                        ...
                        <div class="card-header">
                            Change Company Profile Picture
                        </div>
                        <div class="card-body">
