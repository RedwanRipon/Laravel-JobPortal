        ...
        <div class="row">
            <div class="col-md-3">
                @if(empty(Auth::user()->profile->avatar))
                    ...
                    @else
                       <img style="border-radius: 50px;width: 100%;margin-bottom: 5px" width="80" height="190" src="{{asset('uploads/avatar')}}/{{Auth::user()->profile->avatar}}" alt="image">
                @endif
                ...
                <div class="card mb-2">
                    ...
                    <div class="card-body">
                       <p><b>Name: </b> {{Auth::user()->name}}</p>
                        ...
                        @else
                            <p>Please Uploaded Your Resume</p>
                        @endif
                    </div>
                </div>
                <div class="card mb-2">
